      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-600 mb-2">
            Know more about available careers <a href="https://www.yumtra.app" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">https://www.yumtra.app</a>
          </p>
